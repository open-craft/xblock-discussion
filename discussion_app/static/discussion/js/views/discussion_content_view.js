  ...
  if (typeof Backbone !== "undefined" && Backbone !== null) {
    ...
    this.DiscussionContentShowView = (function(_super) {
      ...
      function DiscussionContentShowView() {
        this.toggleClose = __bind(this.toggleClose, this);
        this.toggleReport = __bind(this.toggleReport, this);
        this.togglePin = __bind(this.togglePin, this);
        this.toggleVote = __bind(this.toggleVote, this);
        this.toggleEndorse = __bind(this.toggleEndorse, this);
        this.toggleFollow = __bind(this.toggleFollow, this);
        this.handleSecondaryActionBlur = __bind(this.handleSecondaryActionBlur, this);
        this.handleSecondaryActionEscape = __bind(this.handleSecondaryActionEscape, this);
        this.toggleSecondaryActions = __bind(this.toggleSecondaryActions, this);
        this.updateButtonState = __bind(this.updateButtonState, this);
        _ref1 = DiscussionContentShowView.__super__.constructor.apply(this, arguments);
        return _ref1;
      }
